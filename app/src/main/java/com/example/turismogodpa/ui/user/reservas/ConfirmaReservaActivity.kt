...
import com.example.turismogodpa.ui.user.inicio.InicioFragment
...
class ConfirmaReservaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ivVolver: ImageView = findViewById(R.id.ivVolverRR)
        val tvVolver: TextView = findViewById(R.id.tvVolverRR)
